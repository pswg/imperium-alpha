...
"All [citizens][1] shall have the following right to study the [Book of 
Laws][2], to study the [clauses][3] of laws written therein, and to 
[recite][4] from the Book of Laws directly.
 
  [1]: ROLE::[Citizen]
  [2]: OBJECT::[Imperium].[Laws]
  [3]: OBJECT::[Imperium].[Clauses]
  [4]: OBJECT::[Imperium].[Recite]" , 
